...
<clipboard-copy aria-label="Copy" class="ClipboardButton btn js-clipboard-copy m-2 p-0 tooltipped-no-delay" data-copy-feedback="Copied!" data-tooltip-direction="w" value="output.elasticsearch:
...
setup.kibana:
  host: &quot;10.2.0.4:5601&quot; 
# TODO: Change this to the IP address of your ELK server" tabindex="0" role="button" style="display: inherit;">
